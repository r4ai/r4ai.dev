...
<Image src={arch} alt="Mercury のアーキテクチャ" title="Mercury のアーキテクチャ" class="max-w-screen-sm" />
...
export default () => <Presentation slidesLength={2} Content={MDXContent} />
```
...
<object data={ridaisai2024} type="application/pdf" width="100%" height="700px" class="max-w-screen-lg mx-auto rounded-lg" />
