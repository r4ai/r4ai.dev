...
<Image src={arch} alt="Mercury のアーキテクチャ" title="Mercury のアーキテクチャ" class="max-w-(--breakpoint-sm) bg-zinc-950 p-4 dark:bg-background" />
...
<object data={ridaisai2024} type="application/pdf" width="100%" class="max-w-(--breakpoint-lg) mx-auto rounded-lg aspect-3/2" />
