...
import iconBlobsWebp from "~/assets/images/r4ai/icon-blobs.webp"
  ...
  return (
    ...
    >
      ...
      <div class="col-span-4 text-base text-foreground font-mono sm:col-span-5">
        ...
        <p class="leading-7 [&:not(:first-child)]:mt-6">Webフレームワーク:</p>
        <ul class="my-6 ml-6 list-disc [&>li]:mt-2">
          <li>React</li>
          <li>Next.js</li>
          <li>SolidJS</li>
      ...
      <div class="col-span-4 text-base text-foreground font-mono sm:col-span-8">
        <ul class="mb-6 ml-6 list-disc [&>li]:mt-2">
          <li>
            <a
              href="https://zenn.dev/ricora/articles/5a170c17933c3f"
          ...
          <li>
            <a href="http://r4ai.dev/posts/no-more-cjs" class="hover:underline">
          ...
          <li>
            <a
              ...
              class="hover:underline"
            >
              「Svelte入門 ～100行で作るToDoアプリ～」
            </a>
          </li>
          <li>
            <a
              href="https://zenn.dev/t4aru/articles/4a77ec07432e57"
              class="hover:underline"
            >
